...
{
    [Table("bonddescription", Schema = "importfiles")]
    public class BondDescriptionEntity : CommonEntity
    {
        [Key]
        ...
        public string? Startdatemoex { get; set; }
        ...
        public string? Earlyrepayment { get; set; }
        ...
        public string? Issuesizeplanned { get; set; }
